...
[Website](https://prompts.matrdreams.com) · [Download Prompt Shelf 1.4.4](https://prompts.matrdreams.com/downloads/Prompt-Shelf-1.4.4.dmg?v=29de8342-r2)
...
hdiutil verify "dist/releases/Prompt-Shelf-1.4.4.dmg"
shasum -a 256 "dist/releases/Prompt-Shelf-1.4.4.dmg"
```
